...
/**
 * Put a Track
 * https://developer.spotify.com/documentation/web-api/reference/tracks/put-track/
 */
...
export const playPlaylist = (trackId) => {
  const url = `https://api.spotify.com/v1/me/player/play`;
  const data = JSON.stringify({ context_uri: `spotify:playlist:${trackId}` });
  return axios({ method: "put", url, headers, data });
};

// {
//   "context_uri": "spotify:playlist:37i9dQZF1DWY8U6Zq7nvbE",
//   "offset": {
//     "position": 5
//   },
//   "position_ms": 0
